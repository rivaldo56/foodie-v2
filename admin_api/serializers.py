...
class UserAdminSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'role', 'onboarding_status', 'is_verified', 
...
class ChefAdminSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ChefProfile
        fields = [
            'id', 'user_email', 'user_full_name', 'bio', 'specialties', 
            'average_rating', 'total_bookings', 'is_verified', 
...
class PaymentAdminSerializer(serializers.ModelSerializer):
    client_email = serializers.EmailField(source='client.email', read_only=True)
    booking_code = serializers.CharField(source='booking.confirmation_code', read_only=True)
