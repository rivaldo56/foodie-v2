...
urlpatterns = [
    ...
    path(
        "mpesa/status/<int:mpesa_payment_id>/",
    ...
    path(
        "payouts/<int:pk>/", views.ChefPayoutDetailView.as_view(), name="payout-detail"
    ),
    path(
        "payouts/<int:pk>/process/",
        views.ProcessPayoutView.as_view(),
        name="process-payout",
    ),
]
