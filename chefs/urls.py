...
urlpatterns = [
    ...
    path(
        "<int:chef_id>/reviews/",
        views.ChefReviewListView.as_view(),
        name="chef-reviews",
    ),
    path("reviews/create/", views.ChefReviewCreateView.as_view(), name="create-review"),
    path(
        "reviews/<int:pk>/", views.ChefReviewDetailView.as_view(), name="review-detail"
    ),
    # Certifications
    path(
        "certifications/",
        views.ChefCertificationListView.as_view(),
        name="certifications",
    ),
    path(
        "certifications/create/",
        views.ChefCertificationCreateView.as_view(),
        name="create-certification",
    ),
    path(
        "certifications/<int:pk>/",
        views.ChefCertificationDetailView.as_view(),
    ...
    path(
        "<int:chef_id>/favorite/",
        views.FavoriteChefToggleView.as_view(),
    ...
    # File uploads (portfolio images + certification docs)
    path("upload/", views.MediaUploadView.as_view(), name="chef-upload"),
]
