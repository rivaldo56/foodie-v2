    ...
    if created:
        if instance.role == User.Role.CLIENT:
            ...
            FarmerProfile.objects.create(
                user=instance,
                farm_name=f"{instance.first_name}'s Farm" if instance.role == User.Role.FARMER else f"{instance.first_name}'s Business",
...
def save_user_profile(sender, instance, **kwargs):
    ...
    elif instance.role in [User.Role.FARMER, User.Role.BUSINESS] and hasattr(instance, 'farmer_profile'):
