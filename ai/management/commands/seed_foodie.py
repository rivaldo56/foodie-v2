...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        chef_data = [
            {
                ...
                "dishes": [
                    ...
                    {
                        "name": "Handmade Tagliatelle Carbonara",
                        "price": 1500,
                        "category": "main_course",
                    },
            ...
            },
            {
                ...
                "dishes": [
                    {
                        "name": "Swahili Fish Curry (Samaki wa Kupaka)",
                        "price": 1600,
                        "category": "main_course",
                    },
                    {
            ...
            },
            {
                ...
                "dishes": [
                    ...
                    {
                        "name": "Jackfruit Tacos with Avocado Crema",
                        "price": 1300,
                        "category": "main_course",
                    },
                    {
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Successfully seeded {len(chef_data)} chefs and their dishes!"
            )
        )
