...
class ChatSession(models.Model):
    ...
    session_type = models.CharField(
        max_length=20, choices=SESSION_TYPE_CHOICES, default="general"
    )
    ...
    chef_context = models.ForeignKey(
        ChefProfile, on_delete=models.SET_NULL, null=True, blank=True
    )
...
class UserPreferenceLearning(models.Model):
    ...
    user = models.OneToOneField(
        User, on_delete=models.CASCADE, related_name="preference_learning"
    )
