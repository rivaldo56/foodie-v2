...
class RequestRecommendationView(generics.CreateAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        result = ai_service.generate_menu_recommendations(request.user, preferences)
...
class ChefRecommendationView(generics.CreateAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        result = ai_service.get_chef_recommendations(
            user_preferences=preferences, location=location, budget=budget
        )
...
class UserPreferenceLearningView(generics.RetrieveAPIView):
    ...
    def get_object(self):
        obj, created = UserPreferenceLearning.objects.get_or_create(
