            ...
            <header className="border-b border-white/10 bg-black/40 backdrop-blur sticky top-0 z-30">
                <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8 py-3 sm:py-4 md:py-5">
                    <div className="flex-1 min-w-0">
                        <p className="text-[10px] sm:text-xs uppercase tracking-[0.25em] sm:tracking-[0.35em] text-blue-500 mb-0.5 sm:mb-1">Supplier Console</p>
                        <h1 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold truncate">Manage your distribution</h1>
                        <p className="hidden sm:block text-xs text-white/50 truncate">List products, track bulk orders, and grow your business</p>
                    </div>
                    <span className="hidden md:block text-xs text-white/50 whitespace-nowrap ml-4">Premium Supply • Verified Quality</span>
                </div>
            </header>
