...
class Booking(models.Model):
    ...
    service_type = models.CharField(
        ...
        default=ServiceType.PERSONAL_MEAL
    )
    ...
    # Priority / Commitment
    is_priority = models.BooleanField(default=False, help_text=_("Client committed with a down payment"))
...
class MenuItem(models.Model):
    ...
    preparation_time = models.PositiveIntegerField(help_text=_("Preparation time in minutes"))
    ...
    allergens = models.JSONField(default=list, blank=True)  # e.g., ['nuts', 'shellfish']
    
    # Availability
    is_available = models.BooleanField(default=True)
    seasonal_availability = models.JSONField(default=list, blank=True)  # e.g., ['spring', 'summer']
