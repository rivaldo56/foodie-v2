...
class BookingLifecycleTestCase(TestCase):
    ...
    def test_create_regular_booking(self):
        ...
        data = {
            ...
            "menu_items": [{"menu_item_id": self.menu_item.id, "quantity": 2}],
        }

        from unittest.mock import patch
        
        with patch("payments.paystack_service.paystack_service.initialize_payment") as mock_paystack:
            mock_paystack.return_value = {"success": True, "authorization_url": "http://test", "reference": "ref"}
            ...
            # Base (50*2=100) + Menu (25*2=50) = 150.00 + 15% fee (22.50) = 172.50
            self.assertEqual(booking.total_amount, Decimal("172.50"))
